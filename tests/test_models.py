...
class TestTextEncoder:
    ...
    def test_text_encoder_with_masking(self, text_encoder_config, batch_size, seq_length):
...
class TestMultiModalModel:
    ...
    @pytest.mark.slow
    def test_model_backward_pass(self, model_config, sample_images, sample_text_inputs, sample_labels):
