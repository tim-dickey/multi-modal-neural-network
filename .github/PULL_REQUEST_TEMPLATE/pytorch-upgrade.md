## PyTorch Upgrade: `torch==2.6.2` / `torchvision==0.16.2`

**Summary**
- This PR proposes upgrading PyTorch to `2.6.2` and `torchvision` to `0.16.2` (candidate tested in smoke workflows).
